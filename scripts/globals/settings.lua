...
START_GIL = 50000000; --Amount of gil given to newly created characters.START_INVENTORY = 80; --Starting inventory and satchel size.  Ignores values < 30.  Do not set above 80!
...
EXP_RATE   = 10.000; --Multiplies exp earned from fov.
...
MINING_BREAK_CHANCE     = 0.01; --% chance for the pickaxe to break during mining.  Set between 0 and 1.
...
COFFER_MAX_ILLUSION_TIME = 120;  -- 1 hour
COFFER_MIN_ILLUSION_TIME = 30;  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 120;  -- 1 hour
CHEST_MIN_ILLUSION_TIME  = 30;  -- 30 minutes
...
SNEAK_INVIS_DURATION_MULTIPLIER = 4; -- multiplies duration of sneak,invis,deodorize to reduce player torture. 1 = retail behavior. MUST BE INTEGER.
